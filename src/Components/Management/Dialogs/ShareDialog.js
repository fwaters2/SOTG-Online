...
import { Dialog, DialogContent, DialogTitle, Grid, DialogActions, Button } from '@material-ui/core';
...
export default function ShareDialog({ open, onClose }) {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth>
      ...
      <DialogActions>
        <Button fullWidth variant="contained" onClick={onClose} color="secondary">
          Back
        </Button>
      </DialogActions>
    </Dialog>
